...
// GIT_TYPE git type
type GIT_TYPE string

const (
	GITHUB    = GIT_TYPE("github")
	BITBUCKET = GIT_TYPE("bitbucket")
)

// GitWebHookEvent contains git web hook event data
type GitWebHookEvent struct {
	Type       GIT_TYPE    `json:"gitType"`
...
func (g *GithubWebHookEvent) Validate() error {
	return nil
}
...
func (b *BitbucketWebHookEvent) Validate() error {
	return nil
}
